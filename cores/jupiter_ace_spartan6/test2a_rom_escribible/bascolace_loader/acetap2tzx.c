...
/* 
These timmings are adjusted from the original timmings from the 3.25MHz 
Jupiter ACE to a Z80 frequency of 3.5MHz, as required by the TZX file format 
standard (1.20). To get the actual Jupiter ACE timmings, multiply each
value by 325/350. More information about these timmings at:
