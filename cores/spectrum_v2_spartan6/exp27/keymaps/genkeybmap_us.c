...
int main()
{
    ...
    MAP(PC_EQUAL,SP_EQUAL);
    MAP(MD_SHIFT|PC_EQUAL,SP_PLUS);
    MAP(PC_BRAOPEN,SP_BRAOPEN);
    MAP(MD_SHIFT|PC_BRAOPEN,SP_CUROPEN);
    MAP(PC_BRACLOS,SP_BRACLOS);
    MAP(MD_SHIFT|PC_BRACLOS,SP_BRACLOS);
    MAP(PC_BACKSLA,SP_BACKSLA);
    MAP(MD_SHIFT|PC_BACKSLA,SP_PIPE);
    MAP(PC_APOSTRO,SP_APOSTRO);
    MAP(MD_SHIFT|PC_APOSTRO,SP_QUOTE);
    MAP(PC_COMMA,SP_COMMA);
    MAP(MD_SHIFT|PC_COMMA,SP_LESS);
    MAP(PC_DOT,SP_DOT);
    MAP(MD_SHIFT|PC_DOT,SP_GREATER);
    MAP(PC_SLASH,SP_SLASH);
    MAP(MD_SHIFT|PC_SLASH,SP_QUEST);
    MAP(PC_SEMICOL,SP_SEMICOL);
