...
REM ROM_END
REM ROM_START( orbitron )
REM	ROM_REGION( 0x10000, "maincpu", 0 )
REM	ROM_LOAD( "orbitron.3",   0x0600, 0x0200, CRC(419f9c9b) SHA1(788a3920f4270b886b3a578f8c2df33e6314a1c3) )
REM	ROM_CONTINUE(             0x0400, 0x0200)
REM	ROM_CONTINUE(             0x0200, 0x0200)
REM	ROM_CONTINUE(             0x0000, 0x0200)
REM	ROM_LOAD( "orbitron.4",   0x0e00, 0x0200, CRC(44ad56ac) SHA1(3a8339cdee50912a16ac0fb448e6659e32542c0c) )
REM	ROM_CONTINUE(             0x0c00, 0x0200)
REM	ROM_CONTINUE(             0x0a00, 0x0200)
REM	ROM_CONTINUE(             0x0800, 0x0200)
REM	ROM_LOAD( "orbitron.1",   0x1600, 0x0200, CRC(da3f5168) SHA1(1927cc7cd3b9d15b629e09781557f4c75d684182) )
REM	ROM_CONTINUE(             0x1400, 0x0200)
REM	ROM_CONTINUE(             0x1200, 0x0200)
REM	ROM_CONTINUE(             0x1000, 0x0200)
REM	ROM_LOAD( "orbitron.2",   0x1e00, 0x0200, CRC(a3b813fc) SHA1(7f0f22667bee897b474fb485d65a74d74a36991a) )
REM	ROM_CONTINUE(             0x1c00, 0x0200)
REM	ROM_CONTINUE(             0x1a00, 0x0200)
REM	ROM_CONTINUE(             0x1800, 0x0200)
REM	ROM_LOAD( "orbitron.5",   0x2000, 0x0800, CRC(20cd8bb8) SHA1(a5309cb04a656c6e1e18bb19910474af8ef814a5) )
REM
REM	ROM_REGION( 0x1000, "gfx1", 0 )
REM	ROM_LOAD( "orbitron.6",   0x0000, 0x0800, CRC(2c91b83f) SHA1(29c73b7ad0dc5a3ba739492c902ad9201eae6ef2) )
REM	ROM_LOAD( "orbitron.7",   0x0800, 0x0800, CRC(46f4cca4) SHA1(e5fb616b1d17b5b5167f05f7840638840deb2d13) )
REM
REM	ROM_REGION( 0x0020, "proms", 0 )
REM	ROM_LOAD( "l06_prom.bin", 0x0000, 0x0020, CRC(6a0c7d87) SHA1(140335d85c67c75b65689d4e76d29863c209cf32) )
REM ROM_END

set rom_path_src=orbitron
...
copy /b/y %rom_path_src%\o.3 + %rom_path_src%\o.4 + %rom_path_src%\o.1 + %rom_path_src%\o.2 + %rom_path_src%\orbitron.5 %rom_path%\main.bin 
...
%romgen_path%\romgen %rom_path_src%\orbitron.6    GALAXIAN_1H 11 l r e > %rom_path%\galaxian_1h.vhd
%romgen_path%\romgen %rom_path_src%\orbitron.7    GALAXIAN_1K 11 l r e > %rom_path%\galaxian_1k.vhd
