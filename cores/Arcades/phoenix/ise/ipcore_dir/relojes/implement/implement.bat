...
xst -ifn xst.scr
move relojes_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\relojes_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc relojes_exdes.ucf relojes_exdes

echo 'Running map'
map -timing -pr b relojes_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm relojes_exdes -w routed.ncd routed.vhd
cd ..
