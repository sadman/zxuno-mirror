**Ported to ZX-UNO by Quest 19/8/2015

- Hay que abrir el proyecto con ISE 14.7. Si se abre con versiones anteriores, al sintetizar no cabe en core en el ZX-UNO
- Usar con joystick norma Atari de 2 botones (De Master System o Megadrive principalmente)
- Los botones SELECT y START se consiguen poniendo pulsadores en EXT12 y EXT11 del puerto de expansión respectivamente (a GND)
- Para cargar los juegos hay que conectar el ZX-UNO al puerto serie del ordenador con conversión de niveles. (Ver pines_NES.jpg) y ejecutar en la carpeta "sw" el nesdbg_COMx que corresponda a tu puerto serie.
