cd ..
rem echo  define version 4 > version.asm
call  make.bat
cd roms
Bit2Bin ..\..\cores\spectrum\test20\tld_zxuno_v4.bit tmp.bin
...
call :CreateRom 23 "Inves Spectrum+"          	   inves	    0    8  4 0 32
call :CreateRom 24 "Zx Spectrum +2"          	   plus2en     	    tdn  8  4 0 0
call :CreateRom 26 "Pentagon 128"          	   pentagon	    pcd  8  4 0 0
...
CgLeches rom_taps\%3.tap rom_taps\%3.tzx 7
:eof
