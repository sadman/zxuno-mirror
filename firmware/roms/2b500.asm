...
l02b8   defb    $00, 1, $08, 1, $00, $00, $ff, $ff
        ...
        defb    $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
        defb    $d5, $73, $ff, $ff, $ff, $ff, $ff, $ff
        defb    $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
        defm    'Jet Pac (1983)                  '
        defb    $09, 1, $08, 1, $00, $20, $ff, $ff
        defb    $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
        defb    $5f, $6b, $ff, $ff, $ff, $ff, $ff, $ff
        defb    $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
        defm    'Pssst (1983)                    '
        defb    $0a, 1, $08, 1, $00, $20, $ff, $ff
        defb    $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
        defb    $23, $18, $ff, $ff, $ff, $ff, $ff, $ff
        defb    $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
        defm    'Cookie (1983)                   '
        defb    $0b, 1, $08, 1, $00, $20, $ff, $ff
        defb    $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
        defb    $f9, $86, $ff, $ff, $ff, $ff, $ff, $ff
        defb    $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
        defm    'Tranz Am (1983)                 '
        ...
        defb    $12, 1, $08, 1, $00, $20, $ff, $ff
        defb    $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
        defb    $b8, $18, $ff, $ff, $ff, $ff, $ff, $ff
        defb    $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
        defm    'Manic Miner (1983)              '
        defb    $13, 1, $08, 1, $00, $20, $ff, $ff
        defb    $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff
