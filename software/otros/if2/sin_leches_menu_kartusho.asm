...
LCONT:  CALL    L0D6B           ; call routine CLS to set up system
        ...
        DEFM    'Reset&Play,Antonio Villena'; 26 bytes
...
L1B14:  DEFB    $00             ; Class-00 - No further operands.
        DEFW    GAMES           ; Address: $1793; Address: CAT-ETC
...
string  defb      '   senoJ ocsiM F1 sdiotenalP F'
        defb    '     reniM cinaM E1      ssehC E'
        defb    '   eugolorP alaL D1    caP teJ D'
        defb    '   ylliW teS teJ C1     ssuryG C'
        defb    '      esahchtaeD B1      tsssP B'
        defb    '       sraW ratS A1     eikooC A'
        defb    'ideJ.t fo nruteR 91 nommagkcaB 9'
        defb    '           treBQ 81 egnahC aeS 8', 255, 255
        defb      '        eyepoP 71      sevnI 7'
        defb    '.veR s\'amuzetnoM 61     eSnepO 6'
        defb    '     noitoM ocoL 51 tseTdoeLcM 5'
        defb    '   ecaroH yrgnuH 41 sTrialcniS 4'
        defb    '  nrocinU wodahS 31  sehceLniS 3'
        defb    '        mA znarT 21 sehceLgraC 2'
        defb    '   srediaR ecapS 11    MOR K84 1'
        defb    'sredipS & ecaroH 01 yalP&teseR 0'
